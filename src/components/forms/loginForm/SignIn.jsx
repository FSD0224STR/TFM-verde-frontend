...
export  function SignIn() {
   ...
   return (
      <ThemeProvider theme={main_theme}>
         <Box>
            <Typography variant='h2' sx={{mt:'8rem',fontWeight:'bold',fontFamily:'Dancing Script',textAlign:'center',fontSize:'5rem',color:'primary.main'}}>Bienvenido nuevamente a MeetDancing</Typography>
         </Box>
